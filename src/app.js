// app.js - COMPLETE WITH ALL SUBSCRIPTION + REFERRAL UPDATES
...
const referralRoutes = require('./routes/referral'); // ✅ NEW
...
app.use('/referrals', referralRoutes); // ✅ NEW
